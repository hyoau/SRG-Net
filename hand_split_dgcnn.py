...
label = get_hand_split_label(data_location)
...
with open(f'result/{data_location}/hand_split_dgcnn_label.txt', 'w') as file:
...
with open(f'result/{data_location}/hand_split_dgcnn_result.txt', 'w') as file:
    for i, line in enumerate(color_cloud):
        file.write(f'{line[0]}; {line[1]}; {line[2]}; {line[3]}; {line[4]}; {line[5]}\n')

with open(f'result/{data_location}/hand_split_dgcnn_iou.txt', 'w') as file:
